document.addEventListener("DOMContentLoaded", function() {
    ...
    var getData=function() {
        var crmDataTable = window.localStorage.getItem("crmDataTable");

        if(!crmDataTable){
            var data = [['CPF', 'Cliente', 'E-mail'], ['01829374899', 'Catatau Doménico', 'catatau@domenico.com']];
            window.localStorage.setItem("crmDataTable", JSON.stringify(data));
        } else {    
            var data = JSON.parse(window.localStorage.getItem("crmDataTable"));
        }
